...
## Subtitle (30)
Tabs, sessions, EUC-KR

## Promotional Text (170)
A fast, no-frills plain-text editor for macOS — multiple tabs, automatic session restore (even unsaved notes), and rock-solid Korean/legacy encoding support.
...
notepad,text editor,plain text,txt,메모장,euc-kr,encoding,tabs,utf-8,memo,코드,unicode,에디터

## What's New (4000) — for v1.0
First release.
• Multiple tabs with drag-to-reorder and session restore (including unsaved tabs)
• UTF-8 / UTF-8 BOM / EUC-KR / UTF-16 encodings with reopen & convert
• Inline find & replace, print & page setup, go-to-line, insert date/time
