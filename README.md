...
| **Direct download** | [v1.2.0 DMG](https://github.com/kimmingul/NotepadforMacOS/releases/tag/v1.2.0) (Developer ID · notarized) |
| **Website** | [GitHub Pages](https://kimmingul.github.io/NotepadforMacOS/) |
| **Release notes** | [v1.2](docs/releases/RELEASE_NOTES_v1.2.md) · [v1.1](docs/releases/RELEASE_NOTES_v1.1.md) |
